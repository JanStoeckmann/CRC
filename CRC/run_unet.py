...
def main():
    ...
    if job == 'validate':
        ...
        label_batch_4) in enumerate(validate_loader):
            ...
            final[0].save("data/validate-result/img_{}_generated_0.png".format(batch_number))
            final[1].save("data/validate-result/img_{}_generated_1.png".format(batch_number))
            final[2].save("data/validate-result/img_{}_generated_2.png".format(batch_number))
            final[3].save("data/validate-result/img_{}_generated_3.png".format(batch_number))
            overlay_img.save("data/validate-result/img_{}_overlay.png".format(batch_number))
            final_img.save("data/validate-result/img_{}_generated.png".format(batch_number))
